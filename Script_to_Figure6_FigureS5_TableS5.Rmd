---
title: "Figure 6 & Figure S5 & Table S5"
author: "Lisa Holsten"
date: '2023-09-04'
...
ggsave(filename = "plots/Fig_S5A_MeanBoxplot.pdf", device = cairo_pdf, dpi = "print", height = 4, width = 6)
```
...
### Heatmap of E2F1 target genes (Fig S5B)
...
pheatmap::pheatmap(mat = matrix, 
         ...
         filename = "plots/Fig_S5B_Heatmap_E2F1_targets.pdf",
         width = 6, height = 8)
```
...
ggsave(filename = "plots/Fig_S5C_Network_E2F1.pdf", device = cairo_pdf, dpi = "print", height = 5, width = 5)
```
...
ggsave(filename = "plots/Fig_S5D_Network_MYB.pdf", device = cairo_pdf, dpi = "print", height = 5, width = 5)
```
...
ggsave(filename = "plots/Fig_S5D_Network_STAT1.pdf", device = cairo_pdf, dpi = "print", height = 5, width = 5)
```
...
ggsave(filename = "plots/Fig_S5D_Network_FLI1.pdf", device = cairo_pdf, dpi = "print", height = 5, width = 5)
```
